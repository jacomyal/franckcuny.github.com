...
<a href="https://github.com/">GitHub</a> provide an awesome set of tools for opensource developers. For <a href="http://perldancer.org">Dancer</a>, we try to use them as much as possible. I'll try to show and explain how we do our development.

<img style="display: block; margin-left: auto; margin-right: auto;" src="/static/imgs/github_dancer.jpg" />

h2. code review

<a href="https://github.com/sukria/dancer">Dancer</a>'s development goes fast. We try to ship often, we do a lot of refactoring, and we listen our users. This means processing pull request and issues as fast as possible.
...
We're using "gitflow":https://github.com/nvie/gitflow to work. Gitflow is a nice tool that help you to create and merge branches. If you don't know gitflow, there is "a good article that explain the reason behind it":http://nvie.com/posts/a-successful-git-branching-model/.

Ok, this has nothing to do with GitHub, but I'll explain quickly what we do with this.

Whe use the following convention:
...
It's very rare that we need to push a hotfix or release branch to GitHub: thoses branches had a really a short life span. But *topic* branches can be pushed, when we want feedback from users or other developers.
